...
function StockPopup(props: any) {
  return (
    <div className="bg-white w-ps h-ph absolute top-9 left-5 rounded-md">
      <div className="bg-grey h-20 rounded border-b border-grey-dark p-4 flex items-center justify-between">
        ...
        <div>
          <ArrowsExpandIcon className="cursor-pointer h-9 w-9 p-2 rounded bg-white border border-grey-dark text-grey-font mr-2" />
        </div>
      </div>
      <div className="p-4">
        <div className="space-y-1">
      ...
      <div className="bg-grey h-16 rounded border-t border-grey-dark p-4 flex items-center justify-between">
        <BookmarkIcon className="cursor-pointer h-9 w-9 p-2 rounded bg-white border border-grey-dark text-grey-font mr-2" />
        <button className="h-9 border-t border-grey-dark w-40 flex items-center bg-white">
        ...
        <button className="h-9 border-t border-grey-dark w-40 flex items-center bg-primary-blue rounded justify-center">
